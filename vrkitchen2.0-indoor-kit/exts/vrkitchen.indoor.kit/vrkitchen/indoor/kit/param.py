...
# Asset paths
ASSET_PATH =  ROOT + "/sample/"
SCENE_ASSET_PATH = ROOT + "/sample/scenes/"
SAPIEN_ASSET_PATH = ROOT  + "/sample/sapien_parsed/"
CUSTOM_ASSET_PATH = ROOT  + "/sample/custom/"
HOUSE_INFO_PATH = ROOT +  "/sample/house/"
STORAGE_ASSET_PATH =  ROOT + "/sample/sapien_parsed/StorageFurniture/"

# Data path
DATA_PATH = ROOT + "/data/"
DATA_PATH_NEW = ROOT + "/data_auto/"
ROBOT_PATH = ROOT + "/sample/robot/"
...
# Task
TASK_TYPES = ["pickup_object","reorient_object", 
    "tap_water", "transfer_water", "pour_water",
